    ...
    return (
        <div className="w-[100%] h-20 border-b-2 border-black flex justify-between items-center px-6">
            <div className="flex gap-6 w-[60%] items-center">
                <p className="w-[15%] cursor-pointer hover:animate-pulse">Logo</p>
            ...
            <p className="w-fit border-l-2 border-black py-4 pl-8 cursor-pointer hover:animate-pulse">Sign in</p>
        </div>
    )
}
